...
class MdPlusWidget extends StatefulWidget {
  const MdPlusWidget({
    super.key,
  ...
  static String routeName = 'MD_PLUS';
  static String routePath = 'mdPlus';

  @override
  State<MdPlusWidget> createState() => _MdPlusWidgetState();
}

class _MdPlusWidgetState extends State<MdPlusWidget>
    with TickerProviderStateMixin {
  late MdPlusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MdPlusModel());
