...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      ...
      'faq_a2': 'الدفع عبر Apple In-App Purchase على أجهزة آبل.',
      ...
      'plan_activated': 'تم تفعيل باقة',
      'purchase_restored': 'تم استعادة المشتريات بنجاح',
      'purchase_ios_only': 'الشراء متاح حالياً فقط عبر تطبيق iOS',
      'purchase_from_ios': 'يرجى الترقية من تطبيق iOS على جهاز آيفون أو آيباد',
    ...
    'en': {
      ...
      'faq_a2': 'Payment via Apple In-App Purchase on Apple devices.',
      ...
      'purchase_ios_only': 'Purchases are currently only available via the iOS app',
      'purchase_from_ios': 'Please upgrade from the iOS app on your iPhone or iPad',
