...
class MsignInWidget extends StatefulWidget {
  const MsignInWidget({super.key});

  static String routeName = 'MsignIn';
  static String routePath = 'msignIn';

  @override
  State<MsignInWidget> createState() => _MsignInWidgetState();
}

class _MsignInWidgetState extends State<MsignInWidget>
    with TickerProviderStateMixin {
  late MsignInModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MsignInModel());
                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataF6u =
                                                  false;
                                            }
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((_model.uploadedLocalFile_uploadDataF6u.bytes
                                ...
                                {
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataUg7 = true);
                                  var selectedUploadedFiles =
                                      <FFUploadedFile>[];
                                  ...
                                  try {
                                    selectedUploadedFiles = _model
                                            .uploadedLocalFile_uploadDataF6u
                                            .bytes!
                                            .isNotEmpty
                                        ? [
                                            _model
                                    ...
                                    _model.isDataUploading_uploadDataUg7 =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                          selectedMedia.length &&
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataUg7 =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataUg7 =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                              ...
                              await merchantsRecordReference.set({
                                ...createMerchantsRecordData(
                                  name: _model.textController1.text,
                                  logoUrl: _model.uploadedFileUrl_uploadDataUg7,
                                  address: _model.textController3.text,
                                  contactPerson: _model.textController4.text,
                                  phone: currentPhoneNumber,
                                  email: _model.textController5.text,
                                  userId: currentUserReference,
                                  dec: _model.textController2.text,
                                ),
                                ...mapToFirestore(
                                  {
                              ...
                              await currentUserReference?.update(
                                createUserRecordData(
                                  linkedMerchants: merchantsRecordReference,
                                  userType: 'merchant',
                                ),
                              );
