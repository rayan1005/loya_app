...
class UserRecord extends FirestoreRecord {
  ...
  // "Linked_Merchants" field.
  DocumentReference? _linkedMerchants;
  DocumentReference? get linkedMerchants => _linkedMerchants;
  bool hasLinkedMerchants() => _linkedMerchants != null;
  ...
  void _initializeFields() {
    ...
    _linkedMerchants = snapshotData['Linked_Merchants'] as DocumentReference?;
  }
...
Map<String, dynamic> createUserRecordData({
  ...
  DateTime? uploadTime,
  String? userType,
  DocumentReference? linkedMerchants,
}) {
...
class UserRecordDocumentEquality implements Equality<UserRecord> {
  ...
  bool equals(UserRecord? e1, UserRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.linkedMerchants == e2?.linkedMerchants;
  }
